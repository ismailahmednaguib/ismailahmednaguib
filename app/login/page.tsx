...
export default async function Login({ searchParams }: Props) {
  ...
  <div className="login-card"><LoginForm locale="ar" emailLabel={t("loginEmail", "البريد الإلكتروني")} passLabel={t("loginPass", "كلمة المرور")} btnLabel={t("loginBtn", "دخول")} showLabel={t("loginShow", "إظهار")} hideLabel={t("loginHide", "إخفاء")} /></div>
