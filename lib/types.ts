...
export interface Book { slug: string; title: string; author: string; track: Track; pages: number; pdfUrl: string; desc: string; tags?: string[]; category?: string; published?: boolean; order?: number; }
